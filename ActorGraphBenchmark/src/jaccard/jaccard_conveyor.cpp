...
double get_edge_degrees(sparsemat_t* L, int64_t* edge_degrees) {
    ...
    convey_begin(requests, sizeof(DegreePkt));
    convey_begin(replies, sizeof(DegreePkt));
    lgp_barrier();
...
double jaccard_conveyor(sparsemat_t* A2, double* jaccard_index, int64_t* edge_degrees) {
    ...
    convey_begin(requests, sizeof(JaccardPkt));
    convey_begin(replies, sizeof(JaccardPkt));
    lgp_barrier();
